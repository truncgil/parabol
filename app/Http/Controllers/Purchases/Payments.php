...
class Payments extends Controller
{
    ...
    {
        $accounts = Account::enabled()->orderBy('updated_at','desc')->pluck('name', 'id');
        ...
        $vendors = Contact::vendor()->enabled()->orderBy('updated_at','desc')->take(setting('default.select_limit'))->pluck('name', 'id');
