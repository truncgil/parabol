...
@section('content')
    ...
    width: 300px;"></div></div>
                    ...
                    {{ Form::dateGroup('transferred_at', trans('general.date'), 'calendar', ['id' => 'transferred_at', 'class' => 'form-control datepicker', 'required' => 'required', 'show-date-format' => company_date_format(), 'date-format' => 'Y-m-d H:i:s', 'autocomplete' => 'off'], simdi()) }}
