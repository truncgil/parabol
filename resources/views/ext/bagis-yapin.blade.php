...
@section('title', "Bağış Yapın Geliştirin")
@section('content')

<div class="card">
    <div class="card-body text-center">
        <p>Parabol'ün daha da gelişmesi için bizlere yalnızca {{$_POST['price']}} ₺ bağış yaparak destek olabilirsiniz. Yaptığınız bağışlar için şimdiden çok teşekkürler.</p>
...
$test_mode="";
$timeout_limit = "";
$merchant_ok_url = "https://app.parabol.truncgil.com/{$cid}/ext/bagis-yapin?ok";//"https://www.truncgil.com.tr/pay.php?ok";//"http://www.eu-jer.com/pay.php?success"; // Başarılı ödeme sonrası müşterinizin yönlendirileceği sayfa
$merchant_fail_url ="https://app.parabol.truncgil.com/{$cid}/ext/bagis-yapin?false";//"https://www.truncgil.com.tr/pay.php?false"; //"http://www.eu-jer.com/pay.php?incorrect"; // Ödeme sürecinde beklenmedik bir hata oluşması durumunda müşterinizin yönlendirileceği sayfa
