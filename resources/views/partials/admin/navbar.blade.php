    ...
    top: 18px;" alt="">
            ...
            <ul class="navbar-nav align-items-center ml-md-auto">
                ...
                <li class="nav-item hide-mobile">
                    ...
                    if($change>0) echo("success"); else echo("danger");  ?> m-1">$ {{@$finans['USD']['Buying']}}</a>
                </li>
                <li class="nav-item hide-mobile">
                    <a href="#" class="btn btn-<?php if((@$finans['EUR']['Change'])>0) echo("success"); else echo("danger");  ?> m-1">€ {{@$finans['EUR']['Buying']}}</a>
                </li>
                <li class="nav-item hide-mobile">
                    <a href="#" class="btn btn-<?php if((@$finans['GBP']['Change'])>0) echo("success"); else echo("danger");  ?> m-1">£ {{@$finans['GBP']['Buying']}}</a>
                </li>
                <li class="nav-item hide-mobile">
...
-->
                ...
                <li class="nav-item d-none d-md-block">
                    <a class="nav-link" href="https://truncgil.com.tr/" target="_blank" title="{{ trans('general.help') }}" role="button" aria-haspopup="true" aria-expanded="false">
