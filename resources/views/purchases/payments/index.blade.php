                ...
                <table class="table table-flush table-hover">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            ...
                            <th class="col-lg-2 col-xl-2 d-none d-lg-block text-left">Açıklama</th>
...
<?php $toplam[$item->contact->name] += $item->amount; ?>
                                ...
                                <td class="col-lg-2 col-xl-2 d-none d-lg-block text-left long-texts">{{ $item->description }}</td>
            ...
            <div class="row m-1">
                <div class="col-12">Görünen Listenin Toplamı</div>
