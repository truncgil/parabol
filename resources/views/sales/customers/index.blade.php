...
@section('content')
    ...
    top: 5px;">
                                    ...
                                    <p class="mb-3"><a href="{{ route('customers.show', $item->id) }}" data-abc="true">{{ $item->name }}</a></p>
                                    <ul class="list-inline list-inline-dotted mb-0">
                                        <li class="list-inline-item">
                                            <el-tooltip content="{{ !empty($item->phone) ? $item->phone : trans('general.na') }}"
                                                effect="dark"
                                                placement="top">
                                                <span>{{ !empty($item->email) ? $item->email : "" }}</span>
                                            </el-tooltip>    
    ...
    top: 5px;">
                                    ...
                                    <h3 class="mb-0 font-weight-semibold">@money($item->unpaid, setting('default.currency'), true)</h3>
                                    <div style="position: absolute;
    right: 10px;
    bottom: 10px;">
