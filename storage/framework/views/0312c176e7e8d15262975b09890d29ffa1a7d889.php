...
<?php $component = $__env->getContainer()->make(App\View\Components\Documents\Form\Content::class, ['type' => 'bill','document' => $bill,'hideCompany' => true,'hideFooter' => true,'hideEditItemColumns' => true,'isPurchasePrice' => true]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Documents\Script::class, ['type' => 'bill','items' => $bill->items()->get()]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/purchases/bills/edit.blade.php ENDPATH**/ ?>