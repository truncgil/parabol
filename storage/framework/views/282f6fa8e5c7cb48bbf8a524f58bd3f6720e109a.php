<?php echo $__env->yieldPushContent($name . '_input_start'); ?>
    ...
    <div
        ...
        :class="[{'disabled' : <?php echo e($attributes[':disabled']); ?>}, {'has-error': <?php echo e(isset($attributes['v-error']) ? $attributes['v-error'] : 'form.errors.get("' . $name . '")'); ?>}]"
        <?php else: ?>
        ...
        <div class="input-group input-group-merge <?php echo e($group_class); ?>">
            ...
            <?php echo Form::text($name, $value, array_merge([
                'class' => 'form-control',
                'data-name' => $name,
                'data-value' => $value,
...
<?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/partials/form/text_group.blade.php ENDPATH**/ ?>