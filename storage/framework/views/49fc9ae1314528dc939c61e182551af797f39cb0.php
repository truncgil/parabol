<?php $__env->startSection('title', trans_choice('general.bills', 1) . ': ' . $bill->document_number); ?>

<?php $__env->startSection('new_button'); ?>
    <?php if (isset($component)) { $__componentOriginale972011868b1174ce26941ef8ab555616856c4a3 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Documents\Show\TopButtons::class, ['type' => 'bill','document' => $bill,'hideButtonGroupDivider2' => true,'hideButtonCustomize' => true]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Documents\Show\Content::class, ['type' => 'bill','document' => $bill,'hideButtonSent' => true,'hideButtonEmail' => true,'hideButtonShare' => true]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/purchases/bills/show.blade.php ENDPATH**/ ?>