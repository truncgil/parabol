    ...
    <?php echo Form::open([
        ...
        <div class="row">
            <div class="col-md-4 text-center">
                <div class="bg-print border-radius-default print-edge choose" @click="invoice_form.template='default'">
                    <img src="<?php echo e(asset('public/img/invoice_templates/default.png')); ?>" class="mb-1 mt-3" height="200" alt="Default"/>
                    <label>
            ...
            <div class="col-md-4 text-center px-2">
                <div class="bg-print border-radius-default print-edge choose" @click="invoice_form.template='classic'">
                    <img src="<?php echo e(asset('public/img/invoice_templates/classic.png')); ?>" class="mb-1 mt-3" height="200" alt="Classic"/>
                    <label>
                        <input type="radio" name="template" value="classic" v-model="invoice_form.template">
                        <?php echo e(trans('settings.invoice.classic')); ?>
            ...
            <div class="col-md-4 text-center px-0">
                <div class="bg-print border-radius-default print-edge choose" @click="invoice_form.template='modern'">
                    <img src="<?php echo e(asset('public/img/invoice_templates/modern.png')); ?>" class="mb-1 mt-3" height="200" alt="Modern"/>
                    <label>
                        <input type="radio" name="template" value="modern" v-model="invoice_form.template">
                        <?php echo e(trans('settings.invoice.modern')); ?>
        ...
        <div class="row mt-4">
            <?php echo $__env->yieldPushContent('color_input_start'); ?>
                <div class="form-group col-md-12 <?php echo e($errors->has('color') ? 'has-error' : ''); ?>">
                    ...
                    <div class="input-group input-group-merge" id="invoice-color-picker">
                        ...
                        <?php echo Form::text('color', setting('invoice.color'), ['v-model' => 'invoice_form.color', '@input' => 'onChangeColorInput', 'id' => 'color', 'class' => 'form-control color-hex', 'required' => 'required']); ?>
        ...
        <?php echo Form::hidden('_template', setting('invoice.template')); ?>
...
<?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/modals/settings/invoice_template.blade.php ENDPATH**/ ?>