                    ...
                    <div class="header-body text-center">
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-lg-6 col-md-8">
                                <img class="mb-5" src="<?php echo e(asset('public/img/parabol-dark.svg')); ?>" width="75%" alt="Parabol"/>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/layouts/auth.blade.php ENDPATH**/ ?>