            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    <?php if($item->type=="invoice") {
                         ?>
                          <a class="dropdown-item" target="_blank" href="<?php echo e(url("custom/efatura?id=" .$item->id)); ?>">
                          E-Fatura'ya Gönder</a>
                         <?php 
                    } ?>
...
<?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/partials/documents/index/card-table-row.blade.php ENDPATH**/ ?>