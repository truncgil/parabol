        ...
        <div class="text company">
            ...
            <?php if(!$hideCompanyLogo): ?>
                <?php if(!empty($document->contact->logo) && !empty($document->contact->logo->id)): ?>
                    <img  class="c-logo" src="<?php echo e($logo); ?>" alt="<?php echo e($document->contact_name); ?>"/>
                <?php else: ?>
                    <img  class="c-logo" src="<?php echo e($logo); ?>" alt="<?php echo e(setting('company.name')); ?>" />
                <?php endif; ?>
            <?php endif; ?>
...
<div class="row mt-2">
    <div class="col-33">
        <hr class="invoice-classic-line mb-1 mt-4" style="background-color:<?php echo e($backgroundColor); ?>;">
        <hr class="invoice-classic-line" style="background-color:<?php echo e($backgroundColor); ?>;">
    </div>
        ...
        <div class="invoice-classic-frame ml-1">
            <div class="invoice-classic-inline-frame text-center">
                ...
                <?php if(!$hideDocumentNumber): ?>
                    <div class="text company">
                        <strong><?php echo e(trans($textDocumentNumber)); ?>:</strong><br>
        ...
        <div class="text company">
            ...
            <?php echo $__env->yieldPushContent('email_start'); ?>
                <?php if(!$hideContactEmail): ?>
                    <p><?php echo e($document->contact_email); ?></p>
                <?php endif; ?>
            ...
            <?php echo $__env->yieldPushContent('due_at_input_end'); ?>
                ...
                <?php $__currentLoopData = $document->totals_sorted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($total->code == 'total'): ?>
                        <strong><?php echo e(trans($total->name)); ?>:</strong>
                        <span class="float-right"><?php echo money($total->amount - $document->paid, $document->currency_code, true); ?></span><br><br>
                    <?php endif; ?>
                        ...
                        <tr>
                            <?php echo $__env->yieldPushContent('name_th_start'); ?>
                                <?php if(!$hideItems || (!$hideName && !$hideDescription)): ?>
                                    <th class="text-left item"><?php echo e((trans_choice($textItems, 2) != $textItems) ? trans_choice($textItems, 2) : trans($textItems)); ?></th>
                                <?php endif; ?>
                            <?php echo $__env->yieldPushContent('name_th_end'); ?>

                            <?php echo $__env->yieldPushContent('quantity_th_start'); ?>
                                <?php if(!$hideQuantity): ?>
                                    <th class="quantity"><?php echo e(trans($textQuantity)); ?></th>
                                <?php endif; ?>
                            <?php echo $__env->yieldPushContent('quantity_th_end'); ?>

                            <?php echo $__env->yieldPushContent('price_th_start'); ?>
                                <?php if(!$hidePrice): ?>
                                    <th class="price"><?php echo e(trans($textPrice)); ?></th>
                                <?php endif; ?>
                            ...
                            <?php if(!$hideDiscount): ?>
                                <?php if(in_array(setting('localisation.discount_location', 'total'), ['item', 'both'])): ?>
                                    <?php echo $__env->yieldPushContent('discount_td_start'); ?>
                                        <th class="discount"><?php echo e(trans('invoices.discount')); ?></th>
                            ...
                            <?php echo $__env->yieldPushContent('total_th_start'); ?>
                                <?php if(!$hideAmount): ?>
                                    <th class="total"><?php echo e(trans($textAmount)); ?></th>
                                <?php endif; ?>
            ...
            <?php $__currentLoopData = $document->totals_sorted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($total->code != 'total'): ?>
                    ...
                    <div class="border-top-dashed py-2">
                        ...
                        <span><?php echo money($total->amount, $document->currency_code, true); ?></span>
                    </div>
                ...
                <?php else: ?>
                    <?php if($document->paid): ?>
                        ...
                        <div class="border-top-dashed py-2">
                            ...
                            <span>- <?php echo money($document->paid, $document->currency_code, true); ?></span>
                        </div>
...
<?php if(!$hideFooter): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/components/documents/template/classic.blade.php ENDPATH**/ ?>