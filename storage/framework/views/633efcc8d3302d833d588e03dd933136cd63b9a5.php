<?php $__env->startSection('title', trans('general.title.new', ['type' => setting('bill.title', trans_choice('general.bills', 1))])); ?>

<?php $__env->startSection('content'); ?>
    <?php if (isset($component)) { $__componentOriginal65f407161587e1ef6fcf5e6721fd346b2050e09f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Documents\Form\Content::class, ['type' => 'bill','hideCompany' => true,'hideFooter' => true,'hideEditItemColumns' => true,'isPurchasePrice' => true]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/purchases/bills/create.blade.php ENDPATH**/ ?>