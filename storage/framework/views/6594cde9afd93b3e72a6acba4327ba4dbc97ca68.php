...
} elseif ($_instance->childHasBeenRendered('OjrlWyt')) {
    $componentId = $_instance->getRenderedChildComponentId('OjrlWyt');
    $componentTag = $_instance->getRenderedChildComponentTagName('OjrlWyt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OjrlWyt');
} else {
    $response = \Livewire\Livewire::mount('common.search', []);
    $html = $response->html();
    $_instance->logRenderedChild('OjrlWyt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH E:\Works\xampp\htdocs\parabol\resources\views/partials/admin/navbar.blade.php ENDPATH**/ ?>