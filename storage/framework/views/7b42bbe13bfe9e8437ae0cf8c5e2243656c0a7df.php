...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open([
        ...
        <?php echo $__env->yieldPushContent('forgotten-password-start'); ?>
            ...
            <div class="mt-5">
                <a href="<?php echo e(url('auth/create')); ?>" class="btn btn-info btn-block">Yeni Hesap Oluştur</a>
            </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/auth/login/create.blade.php ENDPATH**/ ?>