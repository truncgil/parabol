<?php $__env->startSection('title', trans('payments.payment_made')); ?>

<?php $__env->startSection('new_button'); ?>
    <?php if (isset($component)) { $__componentOriginalcb0b964f0e079037e8bdb200dbb5f21ab45479f0 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Transactions\Show\TopButtons::class, ['type' => 'expense','transaction' => $payment,'hideButtonShare' => true,'hideButtonEmail' => true]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Transactions\Show\Content::class, ['type' => 'expense','transaction' => $payment]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Transactions\Script::class, ['type' => 'expense']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/purchases/payments/show.blade.php ENDPATH**/ ?>