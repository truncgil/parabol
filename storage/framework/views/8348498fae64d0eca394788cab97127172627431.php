        ...
        <div class="col-xs-12 col-sm-6 text-center p-5">
            ...
            <?php if($checkPermissionCreate): ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($permissionCreate)): ?>
                    <a href="<?php echo e(route($routeCreate)); ?>" class="btn btn-success float-right mt-4">
...
<?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/components/empty-page.blade.php ENDPATH**/ ?>