...
<div class="card">
    <div class="card-body text-center">
        <p>Parabol, başka bir geliri olmayan ve sürekli giderleri olan uygulamadır. Geliştiricileri olarak bizlere daha fazla destek olmak için yalnızca <?php echo e($_POST['price']); ?> ₺ ödeme yapabilirsiniz. Yapmış olduğunuz ödemeler için şimdiden teşekkürlerimizi sunarız.</p>
...
$test_mode="";
$timeout_limit = "";
$merchant_ok_url = "https://app.parabol.truncgil.com/{$cid}/ext/odeme-yapin?paytr=ok";//"https://www.truncgil.com.tr/pay.php?ok";//"http://www.eu-jer.com/pay.php?success"; // Başarılı ödeme sonrası müşterinizin yönlendirileceği sayfa
$merchant_fail_url ="https://app.parabol.truncgil.com/{$cid}/ext/odeme-yapin?paytr=false";//"https://www.truncgil.com.tr/pay.php?false"; //"http://www.eu-jer.com/pay.php?incorrect"; // Ödeme sürecinde beklenmedik bir hata oluşması durumunda müşterinizin yönlendirileceği sayfa

// Müşterinin sepet içeriği - Ürün adedine göre çoğaltabilirsiniz
$user_basket = base64_encode(json_encode(array(
    array("Parabol", "$price", 1) // 1. ürün (Adı - Birim Fiyatı - Adeti )
    )));
$currency = "{$_POST['cur']}";
...
<script src="https://www.paytr.com/odeme/taksit-tablosu/v2?token=c329bbf9a381001d274d4028a0bd1b8f0f6082be7158971b5c8bdddf65a42249&merchant_id=127117&amount=<?php echo $_POST['price']; ?>&taksit=0&tumu=0"></script>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/ext/odeme-yapin.blade.php ENDPATH**/ ?>