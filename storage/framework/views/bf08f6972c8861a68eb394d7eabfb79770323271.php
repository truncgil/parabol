<?php $__env->startSection('title', trans('general.title.new', ['type' => setting('invoice.title', trans_choice('general.invoices', 1))])); ?>

<?php $__env->startSection('content'); ?>
    <?php if (isset($component)) { $__componentOriginal65f407161587e1ef6fcf5e6721fd346b2050e09f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Documents\Form\Content::class, ['type' => 'invoice']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/sales/invoices/create.blade.php ENDPATH**/ ?>