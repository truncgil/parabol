...
} elseif ($_instance->childHasBeenRendered('bFX5Dbk')) {
    $componentId = $_instance->getRenderedChildComponentId('bFX5Dbk');
    $componentTag = $_instance->getRenderedChildComponentTagName('bFX5Dbk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bFX5Dbk');
} else {
    $response = \Livewire\Livewire::mount('common.search', []);
    $html = $response->html();
    $_instance->logRenderedChild('bFX5Dbk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <div class="calculate-result"></div>
            <?php endif; ?>
            <a class="show-mobile" href="./">
                <img src="public/img/parabol-dark.svg" style="    position: absolute;
    width: 140px;
    left: calc(50% - 70px);
    top: 18px;" alt="">
            </a>
            <ul class="navbar-nav align-items-center ml-md-auto">
                ...
                <li class="nav-item d-sm-none hide-mobile">
                ...
                <li class="nav-item hide-mobile">
                    <a href="#" class="btn btn-<?php 
                    $change =(@$finans['USD']['Change']);
                  
                    
                    if($change>0) echo("success"); else echo("danger");  ?> m-1">$ <?php echo e(@$finans['USD']['Buying']); ?></a>
                </li>
                <li class="nav-item hide-mobile">
                    <a href="#" class="btn btn-<?php if((@$finans['EUR']['Change'])>0) echo("success"); else echo("danger");  ?> m-1">€ <?php echo e(@$finans['EUR']['Buying']); ?></a>
                </li>
                <li class="nav-item hide-mobile">
                    <a href="#" class="btn btn-<?php if((@$finans['GBP']['Change'])>0) echo("success"); else echo("danger");  ?> m-1">£ <?php echo e(@$finans['GBP']['Buying']); ?></a>
                </li>
                <li class="nav-item hide-mobile">
                    <a href="https://finans.truncgil.com" target="_blank">
                            <img src="https://finans.truncgil.com/logo.svg" style="height:30px;" alt="">
                        </a>
                </li>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['create-sales-invoices', 'create-sales-revenues', 'create-sales-invoices', 'create-purchases-bills', 'create-purchases-payments', 'create-purchases-vendors'])): ?>
                    ...
                    <li class="nav-item dropdown hide-mobile">
                        ...
                        <a class="nav-link" id="plus-event" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<!--
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('read-install-updates')): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('updates.index')); ?>" title="<?php echo e($updates); ?> Updates Available" role="button" aria-haspopup="true" aria-expanded="false">
                            <span>
...
-->
                ...
                <li class="nav-item d-none d-md-block">
                    <a class="nav-link" href="https://truncgil.com.tr/" target="_blank" title="<?php echo e(trans('general.help')); ?>" role="button" aria-haspopup="true" aria-expanded="false">
...
<?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/partials/admin/navbar.blade.php ENDPATH**/ ?>