...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
<?php 
//Expected response code 250 but got code "553", with message "553 5.7.1 Sender address rejected: not owned by auth user. 1639128002-LF4BCNdVeN-K2Pab91c hatasını engellemek için 
//db("settings")->where("company_id",$cid)->update(['email.protocol',])
//print2($templates);
$templates = mail_template_upgrade(company_id());
?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/settings/email/edit.blade.php ENDPATH**/ ?>