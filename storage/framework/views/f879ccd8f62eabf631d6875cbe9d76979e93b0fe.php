            ...
            <ul class="list-group mb-4">
                ...
                <li class="list-group-item border-0 border-top-1">
                    ...
                    <?php if($customer->phone!="") {
                        $tutar = @money($amounts['overdue'], setting('default.currency'), true);
                        $tutar = str_replace("₺","TL",$tutar);
                        $name = Str::slug($customer->name," ");
                        $name = strtoupper($name);
                        $text = "Sayin $name kalan bakiyeniz $tutar bilgilerinize sunariz";
                         ?>
                        <script>
                            $(function(){
                                $(".sms-gonder").on("click",function(){
                                    $.get("/<?php echo e(company_id()); ?>/ext/sms",{
                         ...
                         <div class="btn btn-success btn-block sms-gonder"><i class="fa fa-envelope"></i> Bakiyeyi SMS Olarak Gönder</div>
                         <?php 
                    } ?>
                </li>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/sales/customers/show.blade.php ENDPATH**/ ?>