<?php $__env->startComponent('mail::layout'); ?>
    ...
    <?php $__env->slot('header'); ?>
        <?php $__env->startComponent('mail::header', ['url' => config('app.url')]); ?>
            <?php echo e(setting('company.name', config('mail.from.name', config('app.name')))); ?>
...
<?php echo $__env->renderComponent(); ?>
    ...
    <?php $__env->slot('footer'); ?>
        <?php $__env->startComponent('mail::footer'); ?>
            &copy; <?php echo e(date('Y')); ?> <?php echo e(setting('company.name', config('mail.from.name', config('app.name')))); ?>. All rights reserved.
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH /home/pgutrunc/app.parabol.truncgil.com/resources/views/vendor/mail/html/message.blade.php ENDPATH**/ ?>